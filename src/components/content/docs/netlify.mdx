...
Eleventy will use the default page layout and publish this page to `/search` when it builds the site. Visit <https://stork-eleventy-netlify-example.netlify.app/search> to see the final result in action!
