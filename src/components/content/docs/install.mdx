...
- Installing with [Homebrew](https://brew.sh) (macOS):
  ```
  $ brew install jameslittle230/stork-tap/stork
  ```
- Downloading the compiled binary (Ubuntu):
  ```
  $ wget https://github.com/jameslittle230/stork/releases/download/v0.7.3/stork-0.7.3-x86_64-unknown-linux-gnu
...
- Installing with [Cargo](https://crates.io/crates/stork-search) (cross-platform):
  ```
