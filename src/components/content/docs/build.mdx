...
## <span class="badge">New in 0.8!</span> Testing your index 
...
By default, Stork will index all text in a file. However, in the configuration file, you can specify that your files have [Front Matter](https://jekyllrb.com/docs/front-matter/) and Stork will ignore [or parse](/docs/frontmatter-parsing) that frontmatter for each file.
