...
After you've <Link to="/docs">installed Stork</Link>, create a new file called `config.toml` and add the following contents:
...
See the <Link to="/docs/config-ref">Configuration File reference</Link> to see all the options you can add to the configuration file or the File object.
