...
This [TOML file](https://github.com/toml-lang/toml) defines the base directory of all your documents and an array of File maps. Each File map in the array describest:
