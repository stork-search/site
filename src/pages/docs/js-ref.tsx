    ...
    <div>
      ...
      <ul>
        <li>
          ...
          elements in your HTML the Stork library should attach to. This name
          should be the same as the name you put in the <code>data-stork</code>{' '}
          attributes.
        </li>
        <li>
          The <strong>url</strong> parameter is a string that contains the URL
          of your index file. The file at this URL should be a
          publicly-available Stork index file generated by the{' '}
          <code>stork&nbsp;--build</code>{' '}
          command.
        </li>
        <li>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              The minimum length a query must be to request results from the
              index. If this is smaller than the{' '}
              <code>minimum_indexed_substring_length</code> in your index, Stork
              will make unnecessary search requests.
            </td>
          </tr>
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>
              An <strong>Entry</strong> object
            </td>
            <td>The file represented by the result.</td>
          </tr>
          ...
          <tr>
            ...
            <td>
              Array of <strong>Excerpt</strong> objects
            </td>
            <td>Each excerpt visible to the user in the search interface.</td>
          </tr>
          ...
          <tr>
            ...
            <td>Number</td>
            <td>
              The "relevance" score Stork computed for the given entry. Used for
              result ordering for a given query.
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>String</td>
            <td>The URL to where the search result links</td>
          </tr>
          ...
          <tr>
            ...
            <td>Object</td>
            <td>
              A set of key-value pairs passed through from the file object in
              the <Link to="/docs/config-ref">Configuration File</Link>. Can be
              used to pass arbitrary string-based metadata from the index at
              build time to the JS environment at runtime.
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td>String</td>
            <td>
              The excerpt that contains the given search query. Usually
              displayed in a list.
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              The "relevance" score Stork computed for the given entry. Used for
              excerpt ordering within all excerpts in a given result.
            </td>
          </tr>
