...
wget https://files.stork-search.net/releases/v1.4.1-rc.5/stork-ubuntu-20-04
...
<h1>Search</h1>
<link rel="stylesheet" href="https://files.stork-search.net/releases/v1.4.1-rc.5/basic.css" />
