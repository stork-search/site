...
<CodeBlock title="array-of-objects.toml" source={`[input]
${''}
base_directory = "./files"
files = [
...
<CodeBlock title="array-of-tables.toml" source={`[input]
base_directory = "./files"
...
<CodeBlock title="srt-config.toml" source={`[input]
...
<CodeBlock title="output.toml" source={`[input]
...
