...
<CodeBlock
  language="html"
  source={`<script src="https://files.stork-search.net/releases/v1.4.1-rc.6/stork.js"></script>
<!-- Or -->
<script src="https://your-url.com/stork@1.4.1-rc.6.js"></script>`}
/>
...
<CodeBlock
  language="javascript"
  source={`stork.initialize('https://your-url.com/stork@1.4.1-rc.6.wasm')`}
/>
